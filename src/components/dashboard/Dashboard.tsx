...
export const Dashboard = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 p-6 mx-auto max-w-[1600px] w-full overflow-x-hidden">
      {/* Cards Section */}
        ...
        <div className="bg-white rounded-lg shadow-md p-6 h-[300px]">
          ...
          <div className="flex justify-between items-center mt-6">
            ...
            <div className="relative w-[70%]">
              ...
              />
              {amount && (
                <span className="absolute left-6 py-6 top-1/2 -translate-y-1/2 text-lg font-medium text-gray-600">
                 $
                </span>
              )}
              <Button
